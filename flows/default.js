...
const loadFlow = (app) => {
  ...
  app.action('introduced', e => runInFlow(e, async ({ ack, body }) => {
    ...
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 2000)
