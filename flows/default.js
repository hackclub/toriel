...
const loadFlow = (app) => {
  ...
  app.event('message', e => runInFlow(e, async body => {
    ...
    if (messageIsPartOfTutorial(body, correctChannel)) {
      ...
      if (lastBotMessage.includes('What brings you')) {
        ...
        await sendCustomizedMessage(app, body.event.channel, `Neatoio! Well, it looks like the next step on my script is to show you around the community :hack_lub::slack:`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg')
  ...
  app.action('introduced', e => runInFlow(e, async ({ ack, body }) => {
    ...
    await sendMessage(app, body.channel.id, 'Because...', 6000)
    ...
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 3000)
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 1000)
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 1000)
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 1000)
    await sendCustomizedMessage(app, body.channel.id, `They're trying to hide it.`, 'https://cloud-8iwducj5z.vercel.app/moshed-2020-9-8-13-47-17.jpg', null, 1000)
